...
from ..SpamPurge_Resources.Filters import filter_variables as filter
...
def prepare_filter_mode_strings(scanMode, filterMode, config, cmntInput):
  if filterMode == "Username":
    whatToScanMsg = "Usernames"
  elif filterMode == "Text":
    whatToScanMsg = "Comment Text"
